package com.hivetech.calender.demo;
...
public class calendarQuickstart {
    ...
    private static final String CREDENTIALS_FILE_PATH = "/lol.json";
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException, NullPointerException {
        ...
        HttpRequestInitializer httpRequestInitializer = httpRequest -> {
            ...
            String accessToken = "ya29.Il_AB1yBlU-EduNMLZXuWum1nlvZ8wkWs9Ps3H5oeGevqU00vhhQkn25nkgPhVg7AYr-l7v5K_iu3NRukzp4KK393siciwGbNC0Irrnav8VOZoeE5LG9DcgAKzwyq8AcMg";
        ...
        Events events = service.events().list("primary")
                .setMaxResults(100)
                .setTimeMin(new DateTime(Instant.now().minus(1500, ChronoUnit.DAYS).getEpochSecond()))
